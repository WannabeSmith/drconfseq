...
computations_dir = here('paper_plots/computations')
```
...
load(here(computations_dir, 'start_time/start_time.RData'))
...
```{r}
load(here(computations_dir, 'cs_vs_ci/cs_vs_ci.RData'))
...
load(here(computations_dir, 'observational_study_SL/observational_study_SL.RData'))
...
```{r}
load(here(computations_dir, '/sepsis/sepsis_cs.RData'))
